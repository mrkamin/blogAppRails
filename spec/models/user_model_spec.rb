...
RSpec.describe User, type: :model do
  subject(:user) do
    User.new(name: 'Rafi Amin', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.',
             posts_counter: 0)
  end
  ...
  describe '#most_three_recent_post' do
    let(:user) { User.new(name: 'Rafi Amin', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.', posts_counter: 0) }
