...
RSpec.describe Post, type: :model do
  user = User.new(name: 'Rafi Amin', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.',
                  posts_counter: 0)
  ...
  describe '#latest_five_comments, update_post_counter private methods' do
    let(:user1) { User.new(name: 'Rafi Amin', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.', posts_counter: 0) }
