...
RSpec.describe 'Showing all posts', type: :feature do
  before(:each) do
    ...
    @first_comment = Comment.create(post: @first_post, author: @first_user, text: 'Hi Rafi!')
    @second_comment = Comment.create(post: @first_post, author: @first_user, text: 'Hi Rafi!')
    @third_comment = Comment.create(post: @fifth_post, author: @first_user, text: 'Hi Rafi!')
    @fourth_comment = Comment.create(post: @sixth_post, author: @first_user, text: 'Hi Rafi!')
    @fifth_comment = Comment.create(post: @sixth_post, author: @first_user, text: 'Hi Rafi!')
